...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometry_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/pomirs_ws/install_isolated/lib;/home/pi/pomirs_ws/devel_isolated/diagnostic_msgs/lib;/home/pi/pomirs_ws/devel_isolated/common_msgs/lib;/home/pi/pomirs_ws/devel_isolated/actionlib_msgs/lib;/home/pi/pomirs_ws/devel/lib;/opt/ros/kinetic/lib)
