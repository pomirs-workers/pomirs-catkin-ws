...
if("TRUE" STREQUAL "TRUE")
  set(runner_SOURCE_PREFIX /home/pi/pomirs_ws/src/runner)
  set(runner_DEVEL_PREFIX /home/pi/pomirs_ws/devel_isolated/runner)
  set(runner_INSTALL_PREFIX "")
  set(runner_PREFIX ${runner_DEVEL_PREFIX})
else()
  set(runner_SOURCE_PREFIX "")
  set(runner_DEVEL_PREFIX "")
  set(runner_INSTALL_PREFIX /home/pi/pomirs_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'runner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/pomirs_ws/src/runner/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT runner_NUM_DUMMY_TARGETS)
      set(runner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::runner::wrapped-linker-option${runner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR runner_NUM_DUMMY_TARGETS "${runner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::runner::wrapped-linker-option${runner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND runner_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/pomirs_ws/devel_isolated/runner/lib;/home/pi/pomirs_ws/devel_isolated/nav_msgs/lib;/home/pi/pomirs_ws/devel_isolated/connector/lib;/home/pi/pomirs_ws/devel_isolated/geometry_msgs/lib;/home/pi/pomirs_ws/devel_isolated/diagnostic_msgs/lib;/home/pi/pomirs_ws/devel_isolated/common_msgs/lib;/home/pi/pomirs_ws/devel_isolated/actionlib_msgs/lib;/home/pi/pomirs_ws/devel/lib;/opt/ros/kinetic/lib)
