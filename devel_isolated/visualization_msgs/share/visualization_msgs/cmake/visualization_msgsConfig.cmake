...
if("TRUE" STREQUAL "TRUE")
  set(visualization_msgs_SOURCE_PREFIX /home/pi/pomirs_ws/src/common_msgs/visualization_msgs)
  set(visualization_msgs_DEVEL_PREFIX /home/pi/pomirs_ws/devel_isolated/visualization_msgs)
  ...
  set(visualization_msgs_INSTALL_PREFIX /home/pi/pomirs_ws/install_isolated)
...
if(NOT "/home/pi/pomirs_ws/devel_isolated/visualization_msgs/include " STREQUAL " ")
  set(visualization_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/pomirs_ws/devel_isolated/visualization_msgs/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/visualization_msgs " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/visualization_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'visualization_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'visualization_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/pomirs_ws/src/common_msgs/visualization_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT visualization_msgs_NUM_DUMMY_TARGETS)
      set(visualization_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::visualization_msgs::wrapped-linker-option${visualization_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR visualization_msgs_NUM_DUMMY_TARGETS "${visualization_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::visualization_msgs::wrapped-linker-option${visualization_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND visualization_msgs_LIBRARIES "${interface_target_name}")
...
set(visualization_msgs_EXPORTED_TARGETS "visualization_msgs_generate_messages_cpp;visualization_msgs_generate_messages_eus;visualization_msgs_generate_messages_lisp;visualization_msgs_generate_messages_nodejs;visualization_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${visualization_msgs_dep}_FOUND)
      find_package(${visualization_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${visualization_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
