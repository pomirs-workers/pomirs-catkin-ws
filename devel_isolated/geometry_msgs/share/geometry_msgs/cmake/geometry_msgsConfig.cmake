...
if("TRUE" STREQUAL "TRUE")
  set(geometry_msgs_SOURCE_PREFIX /home/pi/pomirs_ws/src/common_msgs/geometry_msgs)
  set(geometry_msgs_DEVEL_PREFIX /home/pi/pomirs_ws/devel_isolated/geometry_msgs)
  ...
  set(geometry_msgs_INSTALL_PREFIX /home/pi/pomirs_ws/install_isolated)
...
if(NOT "/home/pi/pomirs_ws/devel_isolated/geometry_msgs/include " STREQUAL " ")
  set(geometry_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/pomirs_ws/devel_isolated/geometry_msgs/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://wiki.ros.org/geometry_msgs " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/geometry_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'geometry_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'geometry_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/pomirs_ws/src/common_msgs/geometry_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT geometry_msgs_NUM_DUMMY_TARGETS)
      set(geometry_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::geometry_msgs::wrapped-linker-option${geometry_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR geometry_msgs_NUM_DUMMY_TARGETS "${geometry_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::geometry_msgs::wrapped-linker-option${geometry_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND geometry_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/pomirs_ws/devel_isolated/geometry_msgs/lib;/home/pi/pomirs_ws/devel_isolated/diagnostic_msgs/lib;/home/pi/pomirs_ws/devel_isolated/common_msgs/lib;/home/pi/pomirs_ws/devel_isolated/actionlib_msgs/lib;/home/pi/pomirs_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(geometry_msgs_EXPORTED_TARGETS "geometry_msgs_generate_messages_cpp;geometry_msgs_generate_messages_eus;geometry_msgs_generate_messages_lisp;geometry_msgs_generate_messages_nodejs;geometry_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${geometry_msgs_dep}_FOUND)
      find_package(${geometry_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${geometry_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
